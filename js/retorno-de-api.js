...
//Leitura Json da API
  var requisicaoJson = "https://api.openweathermap.org/data/2.5/weather?units=metric&lang=pt&lat="+latitude+"&lon="+longitude+"&appid="+ChaveApi;
    ...
    document.getElementById('nascer').innerText = (new Date(out['sys'].sunrise * 1000).toLocaleTimeString("pt-BR", {timeStyle: 'short'}));//Conversão UNIX timestamp em Horas para o Brasil
